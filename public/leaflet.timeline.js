      ...
      return (
        ...
        (t.prototype.prettyPrint = function (t) {
          ...
          var e =
            ...
            '\n';
          return (
            this.right ? (e += this.right.prettyPrint(t + ' │')) : (e += t + ' ├─── ×\n'),
        ...
        return (
              ...
              if (n.parent.isLeftChild)
                (null == (r = n.parent.parent.right) ? void 0 : r.isRed)
                  ? ((n.parent.isRed = !1),
                    ...
                    (n = n.parent.parent))
                  : (n.isRightChild &&
                      ((n = n.parent), this.rotateLeft(n), n.left === i && (i = n), (n = n.left)),
                    s.assert(n.parent),
            ...
            for (
              ...
              if ('left' === f)
                (null == (c = h.right) ? void 0 : c.isRed) &&
                  ((c.isRed = !1), (h.isRed = !0), this.rotateLeft(h), (c = (h = h.left).right)),
                  s.assert(c),
                  (null === (i = c.left) || void 0 === i ? void 0 : i.isRed) ||
                  (null === (r = c.right) || void 0 === r ? void 0 : r.isRed)
                    ? ((null === (o = c.right) || void 0 === o ? void 0 : o.isRed) ||
                      ...
                      (this.isRed = !1))
                    : ((c.isRed = !0),
                      (f = (null == h ? void 0 : h.isLeftChild) ? 'left' : 'right'),
                      (h = h.parent));
              else
                (null == (c = h.left) ? void 0 : c.isRed) &&
                  ((c.isRed = !1), (h.isRed = !0), this.rotateRight(h), (c = (h = h.right).left)),
                  s.assert(c, 'w must be defined'),
                  (null === (a = c.right) || void 0 === a ? void 0 : a.isRed) ||
                  (null === (l = c.left) || void 0 === l ? void 0 : l.isRed)
                    ? ((null === (u = c.left) || void 0 === u ? void 0 : u.isRed) ||
                        (c.right && (c.right.isRed = !1),
                        (c.isRed = !0),
                        this.rotateLeft(c),
                        (c = h.left)),
                      ...
                      (h = void 0),
                      (this.isRed = !1))
                    : ((c.isRed = !0), (f = h.isLeftChild ? 'left' : 'right'), (h = h.parent));
            }
            if (h) {
              var p = h[f];
              p && (p.isRed = !1);
          ...
          (e.prototype.remove = function (t) {
            ...
            if (r)
              if (o) {
                if (
                  ((l = (s = o.leftmostDescendant).isRed), (i = s), (u = 'right'), s.parent === n)
                ) {
                  var h = i[u];
                  h && (h.parent = s);
                } else
  ...
  function (t, e, n) {
    ...
    (r.Timeline = r.GeoJSON.extend({
      ...
      _getInterval: function (t) {
        return (
          !!(t.properties && 'start' in t.properties && 'end' in t.properties) && {
        ...
        return (
          ...
          i(this, function (i) {
            switch (i.label) {
              case 0:
                return e.value
                  ? ((s = r(a(e, n), 2)), (l = s[0]), (u = s[1]), l ? [5, o(t(l, n))] : [3, 2])
                  : [2, void 0];
              case 1:
                i.sent(), (i.label = 2);
              case 2:
    ...
    var o = (function () {
      ...
      return (
        ...
        (t.prototype.remove = function (t, e, n) {
          return this.tree && this.tree.remove({ low: t, high: e, value: n, max: e }), this;
        }),
        (t.prototype.lookup = function (t) {
          ...
          for (var e = [], n = [this.tree]; n.length; ) {
            ...
            i &&
              ...
              i.right && i.value.low <= t && i.right.value.max >= t && n.push(i.right));
          }
          return e;
        }),
    ...
    (i.TimelineSliderControl = i.Control.extend({
      ...
      _makeSlider: function (t) {
        ...
        e.setAttribute('aria-label', 'Slider'),
          ...
          (this._timeSlider = e),
          i.DomEvent.on(this._timeSlider, 'change input', this._sliderChanged, this),
          i.DomEvent.on(
            this._timeSlider,
          ...
          i.DomEvent.on(document.body, 'pointerup mouseup touchend', this._enableMapDragging, this);
      },
      ...
      pause: function (t) {
        ...
        window.clearTimeout(this._timer),
          (this._playing = !1),
          null === (e = this.container) || void 0 === e || e.classList.remove('playing'),
          this.syncedControl &&
            !t &&
        ...
        window.clearTimeout(this._timer),
          ...
          parseFloat(this._timeSlider.value) === this.end
            ? ((this._playing = !1),
              null === (e = this.container) || void 0 === e || e.classList.remove('playing'))
            : ((this._playing = !0),
              null === (n = this.container) || void 0 === n || n.classList.add('playing'),
      ...
      setTime: function (t) {
        this._timeSlider && (this._timeSlider.value = t.toString()),
          this._sliderChanged({ type: 'change', target: { value: t.toString() } });
      },
      onAdd: function (t) {
      ...
      onRemove: function () {
        this.options.enableKeyboardControls && this._removeKeyListeners(),
          i.DomEvent.off(this._timeSlider, 'change input', this._sliderChanged, this),
          i.DomEvent.off(
            this._timeSlider,
            'pointerdown mousedown touchstart',
            this._disableMapDragging,
    ...
    function l(t, e) {
      for (var n = {}, i = [], r = 0; r < t.length; r++) {
        ...
        -1 !== f
          ...
          : a.push({ identifier: h, updater: g(c, e), references: 1 }),
          i.push(h);
      }
      return i;
    }
      ...
      return (
        ...
        (e.i = function (t, n, i) {
          ...
          for (var s = 0; s < t.length; s++) {
            var l = [].concat(t[s]);
            (i && r[l[0]]) ||
              (n && (l[2] ? (l[2] = ''.concat(n, ' and ').concat(l[2])) : (l[2] = n)), e.push(l));
          }
        }),
        e
      );
